...
def drawAll(img, buttonList):
    for button in buttonList:
        ...
        cv2.putText(img, button.text, (x + 12, y + 70), cv2.FONT_HERSHEY_PLAIN, 5, (255, 255, 255), 5)
        ...
        for button in buttonList:
            ...
            if x < lmList[8][0] < x + w and y < lmList[8][1] < y + h:
                ...
                if l < 30:
                    ...
                    sleep(.4)
    # underscore is to ignore some parameter
    cv2.rectangle(img, (50,350), (700,450),(175,0,175), cv2.FILLED)
    cv2.putText(img, finalText, (60, 425), cv2.FONT_HERSHEY_PLAIN, 3, (255, 255, 255), 3)
